...
.. note::
   ...
   Bring in results from 2022-03-29
   
   * bis 11 live hacking bis nach googletest. Projekt, plus switch to
     googletest.
   * 11-12 Clean Code, was meint er
   * 12-13 essen
   * 13-14 TDD, bringing in topics from clean clean section, by
     example
   * ab 14 hands on
