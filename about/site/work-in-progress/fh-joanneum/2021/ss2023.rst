...
.. list-table::
   ...
   * * 
     ...
     * 
       ...
       * :doc:`/trainings/material/soup/cxx-exercises/sensors-core-nopoly/sensor-const-nopoly`
       * :doc:`/trainings/material/soup/cxx-exercises/sensors-core-nopoly/sensor-random-nopoly`
   ...
   * * 
     ...
     * 
       ...
       * :doc:`/trainings/material/soup/cxx-exercises/sensor-avg-nopoly/sensor-avg-nopoly`
   ...
   * * 
	 ...
	 * Prepare according to README (see Github project page)
         * Build as usual
         * Implement requirements:
           :doc:`/trainings/material/soup/cxx-exercises/display-led-stripe-nopoly/display-led-stripe-nopoly`
