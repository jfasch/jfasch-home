   ...
   * * 2022-11-11
	 ...
	 * Download (best into ``<toolchain-dir>``) and modify:
	   ...
	   .. code-block:: text
	      ...
	      set(CMAKE_FIND_ROOT_PATH <toolchain-dir>/armv8-rpi4-linux-gnueabihf/armv8-rpi4-linux-gnueabihf)
	      set(CMAKE_SYSROOT <toolchain-dir>/armv8-rpi4-linux-gnueabihf/armv8-rpi4-linux-gnueabihf)
	 ...
	 * Add a directory ``bin-trainee/`` to your build, and
           register it with your top-level ``CMakeLists.txt``
