...
.. list-table::
   ...
   * * 
     ...
     * **Exercise**
       ...
       * Pi Toolchain file:
         :download:`/about/site/work-in-progress/fh-joanneum/2020/ws2022/armv8-rpi4-linux-gnueabihf.cmake`
   ...
   * * 2022-12-21
     ...
     * **Lab Exam**
       ...
       * ``oo.rst``: dependencies (-> **See also** section)
       * const &
       * Grading (points per test)
       * Fill in
         :doc:`/trainings/material/soup/cxx-exercises/project-setup`
       * Setup project, together with commented-out tests
       * string exercises
