...
def test_summary(monkeypatch):
    ...
    monkeypatch.setattr(Submission, 'warmup', mywarmup)
    ...
    assert studentA_result.detail['test1'] == 5
    assert studentA_result.detail['test2'] == 5
    assert studentA_result.detail['test3'] == 5
    ...
    assert studentB_result.detail['test1'] == 5
    assert studentB_result.detail['test2'] == 5
    assert studentB_result.detail['test3'] == 5
