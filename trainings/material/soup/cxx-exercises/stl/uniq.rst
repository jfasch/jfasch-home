...
.. literalinclude:: /trainings/material/soup/cxx-code/stl-exercises/tests/test-uniq.cpp
   :caption: :download:`/trainings/material/soup/cxx-code/stl-exercises/tests/test-uniq.cpp`
   :language: c++
