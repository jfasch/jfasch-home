...
* Compiler knows the type of a ``std::map`` iterator anyway
  ...
  * |longrightarrow| :doc:`auto <../auto/topic>`
...
* |longrightarrow| :doc:`../structured-binding/topic`
...
* :doc:`auto <../auto/topic>` understands references and ``const`` references
* :doc:`structured binding <../structured-binding/topic>` relies on :doc:`auto
  <../auto/topic>`
