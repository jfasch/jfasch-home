...
.. sidebar:: Contents
   ...
   **Code**: :doc:`c++-stl-container-intro-code/index`

Pointer Arithmetics Recap
-------------------------

.. literalinclude:: c++-stl-container-intro-code/10-pointer-arith-basics.cc
   :caption: :download:`c++-stl-container-intro-code/10-pointer-arith-basics.cc`
   :language: c++
...
.. literalinclude:: c++-stl-container-intro-code/11-pointer-arith-ranges.cc
   :caption: :download:`c++-stl-container-intro-code/11-pointer-arith-ranges.cc`
   :language: c++
...
.. literalinclude:: c++-stl-container-intro-code/20-vector.cc
   :caption: :download:`c++-stl-container-intro-code/20-vector.cc`
   :language: c++
...
.. literalinclude:: c++-stl-container-intro-code/26-vector-algo-copy.cc
   :caption: :download:`c++-stl-container-intro-code/26-vector-algo-copy.cc`
   :language: c++
