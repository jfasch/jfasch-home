...
.. literalinclude:: ../exercises/code/tests/decorator-suite-starting-point.cpp
   :caption: :download:`../exercises/code/tests/decorator-suite-starting-point.cpp`
   :language: c++
...
.. literalinclude:: ../exercises/code/tests/decorator-suite-const-sensor-added-functionality.cpp
   :caption: :download:`../exercises/code/tests/decorator-suite-const-sensor-added-functionality.cpp`
   :language: c++
...
.. literalinclude:: ../exercises/code/tests/decorator-suite-random-sensor-added-functionality.cpp
   :caption: :download:`../exercises/code/tests/decorator-suite-random-sensor-added-functionality.cpp`
   :language: c++
...
.. literalinclude:: ../exercises/code/tests/decorator-suite-const-sensor-is-a-sensor.cpp
   :caption: :download:`../exercises/code/tests/decorator-suite-const-sensor-is-a-sensor.cpp`
   :language: c++
...
.. literalinclude:: ../exercises/code/tests/decorator-suite-random-sensor-is-a-sensor.cpp
   :caption: :download:`../exercises/code/tests/decorator-suite-random-sensor-is-a-sensor.cpp`
   :language: c++
...
.. literalinclude:: ../exercises/code/tests/decorator-suite-decorated-used-in-legacy.cpp
   :caption: :download:`../exercises/code/tests/decorator-suite-decorated-used-in-legacy.cpp`
   :language: c++
