...
.. literalinclude:: ../code/tests-trainee/decorator-suite-starting-point.cpp
   :caption: :download:`../code/tests-trainee/decorator-suite-starting-point.cpp`
   :language: c++
...
.. literalinclude:: ../code/tests-trainee/decorator-suite-const-sensor-added-functionality.cpp
   :caption: :download:`../code/tests-trainee/decorator-suite-const-sensor-added-functionality.cpp`
   :language: c++
...
.. literalinclude:: ../code/tests-trainee/decorator-suite-random-sensor-added-functionality.cpp
   :caption: :download:`../code/tests-trainee/decorator-suite-random-sensor-added-functionality.cpp`
   :language: c++
...
.. literalinclude:: ../code/tests-trainee/decorator-suite-const-sensor-is-a-sensor.cpp
   :caption: :download:`../code/tests-trainee/decorator-suite-const-sensor-is-a-sensor.cpp`
   :language: c++
...
.. literalinclude:: ../code/tests-trainee/decorator-suite-random-sensor-is-a-sensor.cpp
   :caption: :download:`../code/tests-trainee/decorator-suite-random-sensor-is-a-sensor.cpp`
   :language: c++
...
.. literalinclude:: ../code/tests-trainee/decorator-suite-decorated-used-in-legacy.cpp
   :caption: :download:`../code/tests-trainee/decorator-suite-decorated-used-in-legacy.cpp`
   :language: c++
