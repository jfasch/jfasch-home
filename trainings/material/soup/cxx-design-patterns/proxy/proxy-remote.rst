...
.. literalinclude:: ../code/libtrainer/server-thread.h
   :caption: :download:`../code/libtrainer/server-thread.h`
   :language: c++
...
.. literalinclude:: ../code/tests-trainee/proxy-remote-suite.cpp
   :caption: :download:`../code/tests-trainee/proxy-remote-suite.cpp`
   :language: c++
