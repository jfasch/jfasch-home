...
The venerable ``Sensor`` hierarchy that we used in :doc:`adapter` and
in :doc:`proxy-round`, for example, contains a number of classes (to
be extended by real-world sensors one day), that also provide
*values*.
