...
:doc:`interface </trainings/material/soup/cxx03/inheritance-oo-design/index>`):
...
* :download:`RandomSensor
  </trainings/material/soup/cxx-code/sensors-core/sensors/sensor-random.h>`. That sensor yields
  floating point random numbers in a configurable range.
* :download:`ConstantSensor
  </trainings/material/soup/cxx-code/sensors-core/sensors/sensor-const.h>`. That one yield always the
