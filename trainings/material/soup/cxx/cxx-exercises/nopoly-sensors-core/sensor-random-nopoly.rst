...
.. literalinclude:: /trainings/material/soup/cxx/cxx-exercises/nopoly-sensors-core/code/tests/sensor-random-nopoly-basic.cpp
   :language: c++
   :caption: :download:`Download sensor-random-nopoly-basic.cpp
	     </trainings/material/soup/cxx/cxx-exercises/nopoly-sensors-core/code/tests/sensor-random-nopoly-basic.cpp>`
