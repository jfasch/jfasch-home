...
.. literalinclude:: /trainings/material/soup/cxx/cxx-code/stl-exercises/tests/test-filter-generic.cpp
   :caption: :download:`/trainings/material/soup/cxx/cxx-code/stl-exercises/tests/test-filter-generic.cpp`
   :language: c++
