...
.. literalinclude:: /trainings/material/soup/cxx/cxx-exercises/nopoly-switch-mock/code/tests/switch-mock-nopoly-basic.cpp
   :language: c++
   :caption: :download:`Download switch-mock-nopoly-basic.cpp
	     </trainings/material/soup/cxx/cxx-exercises/nopoly-switch-mock/code/tests/switch-mock-nopoly-basic.cpp>`
