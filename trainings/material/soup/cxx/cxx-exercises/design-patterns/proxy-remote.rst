...
.. literalinclude:: /trainings/material/soup/cxx/cxx-code/utilities/utilities/server-thread.h
   :caption: :download:`/trainings/material/soup/cxx/cxx-code/utilities/utilities/server-thread.h`
   :language: c++
...
.. literalinclude:: /trainings/material/soup/cxx/cxx-code/design-patterns-proxy/tests/proxy-remote-suite.cpp
   :caption: :download:`/trainings/material/soup/cxx/cxx-code/design-patterns-proxy/tests/proxy-remote-suite.cpp`
   :language: c++
