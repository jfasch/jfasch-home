...
* Download :download:`onewire-temperature-monolithic.cpp
  </trainings/material/soup/cxx/cxx-exercises/sensor-w1/code/bin/onewire-temperature-monolithic.cpp>`
...
.. literalinclude:: /trainings/material/soup/cxx/cxx-exercises/sensor-w1/code/tests/sensor-w1-suite.cpp
   :caption: :download:`sensor-w1-suite.cpp
             </trainings/material/soup/cxx/cxx-exercises/sensor-w1/code/tests/sensor-w1-suite.cpp>`
   :language: c++
