...
Exercise: Dual ``insert()`` Method In :doc:`/trainings/material/soup/cxx/cxx11/exercises/bag-shared`
----------------------------------------------------------------------------------------------------

Modify the implementation of
:doc:`/trainings/material/soup/cxx/cxx11/exercises/bag-shared` to
