...
.. sidebar:: Topics covered
   ...
   * :doc:`/trainings/material/soup/cxx/cxx03/060-stl/050-associative-containers/map` (and the STL in general)
   * :doc:`/trainings/material/soup/cxx/cxx11/brace-initialization/index`
   * :doc:`/trainings/material/soup/cxx/cxx03/inheritance-oo-design/index` (including C++11 goodies like ``override``, ``final``, ``= delete``, ...)
...
.. sidebar:: See also
   ...
   * :doc:`/trainings/material/soup/cxx/cxx03/060-stl/050-associative-containers/map-index-operator-bad`
   * :doc:`/trainings/material/soup/cxx/cxx03/060-stl/050-associative-containers/map-insert`

* See :doc:`/trainings/material/soup/cxx/cxx03/060-stl/050-associative-containers/map-index-operator-bad`
...
* I don't want to use :doc:`std::map::insert()
  </trainings/material/soup/cxx/cxx03/060-stl/050-associative-containers/map-insert>`
  either
...
* Show what a *functor* is (class with overloaded ``operator()()``)
  (see :doc:`here
  </trainings/material/soup/cxx/cxx11/lambda/lambda-is-functor>`)
...
.. [#tweakable] The course can be adapted to your organization as you
                ...
                </trainings/material/soup/cxx/cxx11/multithreading/index>`,
                for example.
