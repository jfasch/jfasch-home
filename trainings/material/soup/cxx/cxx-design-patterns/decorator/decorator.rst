...
.. literalinclude:: /trainings/material/soup/cxx/cxx-code/design-patterns-decorator/tests/decorator-suite-starting-point.cpp
   :caption: :download:`/trainings/material/soup/cxx/cxx-code/design-patterns-decorator/tests/decorator-suite-starting-point.cpp`
   :language: c++
...
.. literalinclude:: /trainings/material/soup/cxx/cxx-code/design-patterns-decorator/tests/decorator-suite-const-sensor-added-functionality.cpp
   :caption: :download:`/trainings/material/soup/cxx/cxx-code/design-patterns-decorator/tests/decorator-suite-const-sensor-added-functionality.cpp`
   :language: c++
...
.. literalinclude:: /trainings/material/soup/cxx/cxx-code/design-patterns-decorator/tests/decorator-suite-random-sensor-added-functionality.cpp
   :caption: :download:`/trainings/material/soup/cxx/cxx-code/design-patterns-decorator/tests/decorator-suite-random-sensor-added-functionality.cpp`
   :language: c++
...
.. literalinclude:: /trainings/material/soup/cxx/cxx-code/design-patterns-decorator/tests/decorator-suite-const-sensor-is-a-sensor.cpp
   :caption: :download:`/trainings/material/soup/cxx/cxx-code/design-patterns-decorator/tests/decorator-suite-const-sensor-is-a-sensor.cpp`
   :language: c++
...
.. literalinclude:: /trainings/material/soup/cxx/cxx-code/design-patterns-decorator/tests/decorator-suite-random-sensor-is-a-sensor.cpp
   :caption: :download:`/trainings/material/soup/cxx/cxx-code/design-patterns-decorator/tests/decorator-suite-random-sensor-is-a-sensor.cpp`
   :language: c++
...
.. literalinclude:: /trainings/material/soup/cxx/cxx-code/design-patterns-decorator/tests/decorator-suite-decorated-used-in-legacy.cpp
   :caption: :download:`/trainings/material/soup/cxx/cxx-code/design-patterns-decorator/tests/decorator-suite-decorated-used-in-legacy.cpp`
   :language: c++
