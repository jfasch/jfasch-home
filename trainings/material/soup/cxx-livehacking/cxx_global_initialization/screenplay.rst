...
.. literalinclude:: code/01-global.cc
   :caption: :download:`code/01-global.cc`
   :language: c++
...
.. literalinclude:: code/thing.h
   :caption: :download:`code/thing.h`
   :language: c++

Constructor and Destructor Order in Same File
--------------------------------------------- 

.. literalinclude:: code/10-same-file.cc
   :caption: :download:`code/10-same-file.cc`
   :language: c++
...
.. literalinclude:: code/20-different-files.cc
   :caption: :download:`code/20-different-files.cc`
   :language: c++

.. literalinclude:: code/20-thing1.cc
   :caption: :download:`code/20-thing1.cc`
   :language: c++

.. literalinclude:: code/20-thing2.cc
   :caption: :download:`code/20-thing2.cc`
   :language: c++
...
.. literalinclude:: code/30-different-files-bug.cc
   :caption: :download:`code/30-different-files-bug.cc`
   :language: c++

.. literalinclude:: code/30-thing1.cc
   :caption: :download:`code/30-thing1.cc`
   :language: c++

Here is the dependency: ``thing2``'s content is ``thing1``'s plus
extra stuff,

.. literalinclude:: code/30-thing2.cc
   :caption: :download:`code/30-thing2.cc`
   :language: c++
