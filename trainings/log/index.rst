...
Bringing Python to a number of talented programmers - a highly dynamic
and fun course. Booked via my partner `IT-Visions
<https://www.it-visions.at>`__.

Location: Aachen/Herzogenrath, Germany
...
(:doc:`More ... <detail/2022-06-14/index>`)
...
(:doc:`Mehr ... <detail/2022-03-15/index>`)
...
(:doc:`Mehr ... <detail/2022-02-23/index>`)
...
(:doc:`Mehr ... <detail/2021-06-14/index>`)
...
(:doc:`Mehr ... <detail/2021-05-03/index>`)
...
(:doc:`Mehr ... <detail/2021-03-22/index>`)
...
(:doc:`Mehr ... <detail/2020-11-23/index>`)
...
Das ging ziemlich ins Eingemachte. Wenngleich "C" bestellt war, sind
wir doch durch die Neugier und leichtfertige Fragen der Teilnehmer
tief ins System hinabgestiegen.

* :doc:`../repertoire/c-like/c`
* :doc:`../repertoire/c-like/c-advanced`
* :doc:`../repertoire/linux-prog/sysprog/advanced`
...
Feiner Kurs! Die Jungs hatten bei einem internen Forschungsprojekt
einiges zustande gebracht; um mehr machen zu können, haben sie diesen
Kurs gebucht.
...
Ein Kurs für erfahrene C-Programmierer, die von anderen
Betriebssystemen (Windows und Bare-Metal-Embedded) kommen.
...
Eine Einführung in Linux Programmierung für Programmierer, die gut mit
herkömmlichen Embedded OS können.
...
Eine Auffrischung für C-Programmierer, die etwas eingerostet sind, mit
vielen Übungen und einigen Neuigkeiten (wie zum Beispiel Alignment)
für die meisten.
...
.. _records-fraunhofer-2016-07-05:

C for Advanced Users (5.7.2016 - 6.7.2016, Raum Nürnberg)
---------------------------------------------------------

Weils so lustig war, wurde :ref:`die Schulung aus 2015
<records-fraunhofer-2015-06-17>` nocheinmal gebucht. Fortgeschrittener
Tobak, wie gesagt.
...
Eine Schulung für richtig Fortgeschrittene, die mir in den Nächten
zwischen den Schulungstagen Kurzweile bescherte.
...
Systemnahe Programmierung unter Linux (14.4.2014 - 17.4.2014 in Köln)
---------------------------------------------------------------------
...
* :doc:`../repertoire/linux-prog/sysprog/multithreading`
* :doc:`../repertoire/linux-prog/sysprog/advanced`: Signale und IPC
...
Softwareentwicklung unter Linux (20.10.2010 - 24.10.2010, `Mathias Kettner <http://mathias-kettner.de>`__)
----------------------------------------------------------------------------------------------------------
