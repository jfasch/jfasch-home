...
* Control Flow and Iteration
  ...
  * Exercise (cont'd):
    ...
    (`Solution on Github
    <https://github.com/jfasch/2021-08-31/blob/main/live-hacking/greet.py>`__)
...
* `Kesselfall (kids) <https://www.bergfex.at/sommer/steiermark/touren/wanderung/5790,semriach-kesselfall/>`__
* `Rettenbachklamm (kids) <https://www.stadt-graz.at/ausfluege/rettenbachklamm-wanderung.html>`__
* `Hochtor <https://www.alltrails.com/de/trail/austria/styria/hochtor-via-wasserfallweg>`__
* Hochschwab
