...
</trainings/material/soup/cxx/cxx11/introduction/overview-livehacking>`.
...
* And realtime? C++ does not define realtime concepts, so this is an
  OS topic.
* From :doc:`/trainings/material/soup/cxx/cxx11/coroutines/index`
...
* :doc:`/trainings/material/soup/cxx/cxx11/chrono/topic`
